<?php
function test4room($idhotel,$sum1,$sum2,$sum3,$sum4,$arrday,$days){
...
OR HR.numroom IN(
SELECT RR1.numroom FROM reserv_room RR1 where RR1.arrday > ('$arrday' + INTERVAL '$days' DAY)
) OR HR.numroom IN(
SELECT RR2.numroom FROM reserv_room RR2 where  ('$arrday') > ( RR2.arrday+ INTERVAL RR2.days DAY)
))
